(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["streamteam"] = factory();
	else
		root["streamteam"] = factory();
})(this, function() {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var StreamTeam = function StreamTeam(userArgs) {
	    var _this = this;
	    ...
	    this.startBuffer = function () {
	        ...
	        _this.gainNode.connect(window.context.destination);

	        if (_this.sources.length > 1) {
	            var _source = window.context.createBufferSource();
	            _source.buffer = _this.buffers[1];
	            _source.connect(window.context.destination);
	            _this.sources[1] = _source;
	        }

	        _this.sourceJs.onaudioprocess = function () {
	            return _this.audioProcess();
	        };
	    };

	    this.connectNewBuffer = function () {
	        _this.buffers.shift();
	        _this.sources.shift();
	        _this.sources[0].start();
	        ...
	        _this.sources[0].connect(_this.analyser);
	        _this.sources[0].connect(window.context.destination);

	        _this.sources[0].connect(_this.gainNode);
	        _this.gainNode.connect(window.context.destination);
	    ...
	    this.stopBuffer = function () {
	        _this.sourceJs = {};
	        if (_this.sources[0]) _this.sources[0].stop();
	    };

	    this.grabNewBuffer = function (first) {
